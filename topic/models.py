...
class TopicCategory(models.Model):
    ...
    header_color = models.CharField(default="#001D25", max_length=30, verbose_name="头部颜色", help_text="头部颜色")
    ...
    avatar = models.CharField(max_length=50, null=True, blank=True, default="/static/img/default-avatar.png", verbose_name="头像")
    background_img = models.CharField(max_length=50, null=True, blank=True, default="/static/img/default-avatar.png", verbose_name="背景图片")
    theme_color = models.CharField(default="#001D25", max_length=30, verbose_name="主题颜色", help_text="主题颜色")
